...
def block_matching_cv(template_gray, source_gray,  method): 
    ...
    # TODO: figure out how to handle multiple perfect matches
    if (len(np.where(res>=maxval)[0])>=2):
        return [-1]
...
def plot_match(prev_file, next_file, half_template_size=7): 
