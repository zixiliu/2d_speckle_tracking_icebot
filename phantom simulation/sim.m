function sim(y_offset,mat_filename, fig_filename1, fig_filename2, the_ball)
...
% 
    ...
    xlabel('Horizontal Position [mm]');
    ylabel('Depth [mm]');
    title('B-Mode Image Radius 8mm');
    colormap(gray);
    
    savefig(h2, fig_filename2);
